...
pub trait OrgFreedesktopNetworkManager {
    ...
    fn get_global_dns_configuration(&self) -> Result<::std::collections::HashMap<String, arg::Variant<Box<arg::RefArg + 'static>>>, Self::Err>;
    fn set_global_dns_configuration(&self, value: ::std::collections::HashMap<String, arg::Variant<Box<arg::RefArg + 'static>>>) -> Result<(), Self::Err>;
}
...
impl<'a, C: ::std::ops::Deref<Target=dbus::Connection>> OrgFreedesktopNetworkManager for dbus::ConnPath<'a, C> {
    ...
    fn reload(&self, flags: u32) -> Result<(), Self::Err> {
        let mut m = self.method_call_with_args(&"org.freedesktop.NetworkManager".into(), &"Reload".into(), |msg| {
            let mut i = arg::IterAppend::new(msg);
            i.append(flags);
        })?;
        m.as_result()?;
    ...
    fn get_device_by_ip_iface(&self, iface: &str) -> Result<dbus::Path<'static>, Self::Err> {
        let mut m = self.method_call_with_args(&"org.freedesktop.NetworkManager".into(), &"GetDeviceByIpIface".into(), |msg| {
            let mut i = arg::IterAppend::new(msg);
            i.append(iface);
        })?;
        m.as_result()?;
        let mut i = m.iter_init();
        let device: dbus::Path<'static> = i.read()?;
        Ok(device)
    }

    fn activate_connection(&self, connection: dbus::Path, device: dbus::Path, specific_object: dbus::Path) -> Result<dbus::Path<'static>, Self::Err> {
        let mut m = self.method_call_with_args(&"org.freedesktop.NetworkManager".into(), &"ActivateConnection".into(), |msg| {
            let mut i = arg::IterAppend::new(msg);
            i.append(connection);
            i.append(device);
        ...
        m.as_result()?;
        let mut i = m.iter_init();
        let active_connection: dbus::Path<'static> = i.read()?;
        Ok(active_connection)
    }

    fn add_and_activate_connection(&self, connection: ::std::collections::HashMap<&str, ::std::collections::HashMap<&str, arg::Variant<Box<arg::RefArg>>>>, device: dbus::Path, specific_object: dbus::Path) -> Result<(dbus::Path<'static>, dbus::Path<'static>), Self::Err> {
        let mut m = self.method_call_with_args(&"org.freedesktop.NetworkManager".into(), &"AddAndActivateConnection".into(), |msg| {
            let mut i = arg::IterAppend::new(msg);
            i.append(connection);
            i.append(device);
            i.append(specific_object);
    ...
    fn deactivate_connection(&self, active_connection: dbus::Path) -> Result<(), Self::Err> {
        let mut m = self.method_call_with_args(&"org.freedesktop.NetworkManager".into(), &"DeactivateConnection".into(), |msg| {
            let mut i = arg::IterAppend::new(msg);
    ...
    fn sleep(&self, sleep: bool) -> Result<(), Self::Err> {
        let mut m = self.method_call_with_args(&"org.freedesktop.NetworkManager".into(), &"Sleep".into(), |msg| {
            let mut i = arg::IterAppend::new(msg);
            i.append(sleep);
        })?;
        m.as_result()?;
    ...
    fn enable(&self, enable: bool) -> Result<(), Self::Err> {
        let mut m = self.method_call_with_args(&"org.freedesktop.NetworkManager".into(), &"Enable".into(), |msg| {
            let mut i = arg::IterAppend::new(msg);
            i.append(enable);
        })?;
        m.as_result()?;
    ...
    fn get_permissions(&self) -> Result<::std::collections::HashMap<String, String>, Self::Err> {
        let mut m = self.method_call_with_args(&"org.freedesktop.NetworkManager".into(), &"GetPermissions".into(), |_| {
        })?;
        m.as_result()?;
        let mut i = m.iter_init();
        let permissions: ::std::collections::HashMap<String, String> = i.read()?;
        Ok(permissions)
    }

    fn set_logging(&self, level: &str, domains: &str) -> Result<(), Self::Err> {
        let mut m = self.method_call_with_args(&"org.freedesktop.NetworkManager".into(), &"SetLogging".into(), |msg| {
            let mut i = arg::IterAppend::new(msg);
            i.append(level);
            i.append(domains);
        })?;
    ...
    fn get_logging(&self) -> Result<(String, String), Self::Err> {
        let mut m = self.method_call_with_args(&"org.freedesktop.NetworkManager".into(), &"GetLogging".into(), |_| {
        })?;
        m.as_result()?;
        let mut i = m.iter_init();
        let level: String = i.read()?;
        let domains: String = i.read()?;
        Ok((level, domains))
    }

    fn check_connectivity(&self) -> Result<u32, Self::Err> {
        let mut m = self.method_call_with_args(&"org.freedesktop.NetworkManager".into(), &"CheckConnectivity".into(), |_| {
        })?;
        m.as_result()?;
        let mut i = m.iter_init();
        let connectivity: u32 = i.read()?;
        Ok(connectivity)
    }

    fn state(&self) -> Result<u32, Self::Err> {
        let mut m = self.method_call_with_args(&"org.freedesktop.NetworkManager".into(), &"state".into(), |_| {
        })?;
        m.as_result()?;
        let mut i = m.iter_init();
    ...
    fn checkpoint_create(&self, devices: Vec<dbus::Path>, rollback_timeout: u32, flags: u32) -> Result<dbus::Path<'static>, Self::Err> {
        let mut m = self.method_call_with_args(&"org.freedesktop.NetworkManager".into(), &"CheckpointCreate".into(), |msg| {
            let mut i = arg::IterAppend::new(msg);
            i.append(devices);
        ...
        m.as_result()?;
        let mut i = m.iter_init();
        let checkpoint: dbus::Path<'static> = i.read()?;
        Ok(checkpoint)
    }

    fn checkpoint_destroy(&self, checkpoint: dbus::Path) -> Result<(), Self::Err> {
        let mut m = self.method_call_with_args(&"org.freedesktop.NetworkManager".into(), &"CheckpointDestroy".into(), |msg| {
            let mut i = arg::IterAppend::new(msg);
            i.append(checkpoint);
        })?;
        m.as_result()?;
    ...
    fn checkpoint_rollback(&self, checkpoint: dbus::Path) -> Result<::std::collections::HashMap<String, u32>, Self::Err> {
        let mut m = self.method_call_with_args(&"org.freedesktop.NetworkManager".into(), &"CheckpointRollback".into(), |msg| {
            let mut i = arg::IterAppend::new(msg);
            i.append(checkpoint);
        })?;
        m.as_result()?;
        let mut i = m.iter_init();
        let result: ::std::collections::HashMap<String, u32> = i.read()?;
        Ok(result)
    }
